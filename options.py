...
def parse_args():
    ...
    parser.add_argument('--global_epoch', type=int, default=20, help="Number of global epochs")
    ...
    parser.add_argument('--dir_alpha', type=float, default=100, help="the non-iid level. 0 means iid")
